...
export const mockDocuments: ProjectDocument[] = [
  ...
  { id: "p1", name: "Harvest Score™ Report (HS-88)", description: "AI-generated credit score report with 6-dimension breakdown. Ref: HS-MHCC-2025-001.", category: "platform", status: "verified", source: "platform", fileName: "HS_Report_MHCC_2025_001.pdf", fileSize: "3.8MB", uploadedDate: "Sep 15, 2024" },
