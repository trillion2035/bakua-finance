...
export const mockSPV: SPVSummary = {
  ...
  processSteps: [
    ...
    },
    {
      id: 4,
      title: "Listing",
      description: "Smart contract deployed, audited, and SPV listed on the investor marketplace.",
      status: "completed",
      dateRange: "Oct 2–8, 2024",
      details: "Smart contract audited by CertiK. Documents anchored to IPFS. Marketplace listing published.",
    },
    {
      id: 5,
      title: "Funding",
      description: "Investors deposit capital until the SPV target is fully met.",
      status: "completed",
